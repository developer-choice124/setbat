...
class Master extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->pid = $cuser->parent_id;
        $puser = $this->Common_model->get_single_query("select * from users where id = $this->pid");
        $this->parentShowMatch = $puser->show_match;
    }

    public function index() {
        $hdata['title'] = 'Master Panel | Setbat Exch';
        ...
        if($this->showMatch == 'no' || $this->parentShowMatch == 'no') {
            $data = array();
        } else {
    ...
    public function updatePassword() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect('Master/changePassword');
        } else {
            ...
            if ($change) {
                ...
                redirect('Master/changePassword', 'refresh');
            }
        }
    }
    ...
    public function allUsers() {
        ...
        $hdata['p_l'] = $this->p_l;
        $hdata['heading'] = $this->panel->title;
        $users = $this->_outlist($this->Common_model->get_data_by_query("select * from users_with_groups where group_name = 'user' and parent_id = $this->id and deleted = 'no' order by id DESC"));
        ...
        $this->load->view('layout/backend_header', $hdata);
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/allusers',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function resetUserPassword() {
        ...
        if($this->form_validation->run() == true) {
            ...
            $ug = $this->Common_model->findfield('users_with_groups','id',$id,'group_name');
            $new = $this->input->post('new');
            $q = $this->db->select('email, password, salt')->from('users')->where('id',$id)->get()->row();
            ...
            redirect('Master/allUsers', 'refresh');
        }
    ...
    public function addMoney()
    {
        ...
        $mcdata = array(
            ...
            'debits'            => $chips,
            'balance'           => $mcbalance,
            'description'       => 'Transferred to '.$this->Common_model->findfield('users','id',$uid,'email'),
            'transferred_to'    => $uid,
    ...
    public function userBetHistory() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/userbet_history',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function userAccountStatement() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/useraccount_statement',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function statementByMatchId() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/statementby_matchid',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function oddFancyByMatchId() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/oddfancyby_matchid',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function userProfitLoss() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/userprofit_loss',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function bet() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/bet',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function accountInfo() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/account_info',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function accountStatement() {
        ...
        $data['statements'] = $st;
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/account_statement',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function chipHistory() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/chip_history',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function chipSummaryOld() {
        ...
        $data['sdown'] = $sdown;
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/chip_summary',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function chipSummary() {
        ...
        if($group == 'user') {
            redirect('Master/userChipSummary?user_id='.$uid);
        } elseif($group == 'master') {
            redirect('Master/masterChipSummary?user_id='.$uid);
        } elseif($group == 'supermaster') {
            redirect('Master/superMasterChipSummary?user_id='.$uid);
        } elseif($group == 'admin') {
            redirect('Master/adminChipSummary?user_id='.$uid);
        }
    ...
    public function userChipSummary() {
        ...
        $data['cuser'] = $uid;
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/userchip_summary',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function masterChipSummary() {
        ...
        $data['cuser'] = $uid;
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/masterchip_summary',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function chipSettlement() {
        ...
        redirect('Master/chipSummary?user_id='.$cid);
    }
    ...
    public function profitLoss() {
        ...
        $data['statements'] = $st;
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/profit_loss',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function betByMatchId() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/bet_matchid',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function betHistory() {
        ...
        $hdata['heading'] = $this->panel->title;
        $this->load->view('layout/backend_header', $hdata);
        $data['bets'] = $this->Common_model->get_data_by_query("SELECT a.*, b.username FROM `bet` a LEFT JOIN users b ON a.user_id = b.id WHERE a.user_id IN (SELECT id FROM users WHERE parent_id = $this->id) order by a.id DESC");
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/bet_history',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function showMatches(){
        ...
        $getUSerDetail->parent_detail = $this->Common_model->get_record_by_id("users" ,$getUSerDetail->parent_id);
        $sid = $getUSerDetail->parent_detail->parent_id;
        
        $EventList = $this->Common_model->get_data_by_query("SELECT * FROM event_block WHERE user_id IN ($user_id, $getUSerDetail->parent_id, $sid  )");
        $eventIds = [];
    ...
    public function runningCricket() {
        ...
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/running_matches',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function matchOdds() {
        ...
        $data['ubets']= $this->Common_model->get_data_by_query("SELECT * FROM bet WHERE market_id = '$mid' AND bet_type = 'unmatched' AND user_id IN (SELECT id FROM users WHERE parent_id = $this->id)");
        $data['mbets']= $this->Common_model->get_data_by_query("SELECT * FROM bet WHERE market_id = '$mid' AND bet_type = 'matched' AND user_id IN (SELECT id FROM users WHERE parent_id = $this->id)");
        $data['fbets']= $this->Common_model->get_data_by_query("SELECT * FROM bet WHERE market_id = '$mid' AND bet_type = 'fancy' AND user_id IN (SELECT id FROM users WHERE parent_id = $this->id)");
        $this->load->view('layout/backend_sidebar');
        $this->load->view('master/match_odds',$data);
        $this->load->view('layout/backend_footer');
    }
    ...
    public function betReload() {
        $mid = $this->input->get('market_id');
        $ubets = $this->Common_model->get_data_by_query("SELECT * FROM bet WHERE market_id = '$mid' AND bet_type = 'unmatched' AND user_id IN (SELECT id FROM users WHERE parent_id = $this->id)");
        $mbets = $this->Common_model->get_data_by_query("SELECT * FROM bet WHERE market_id = '$mid' AND bet_type = 'matched' AND user_id IN (SELECT id FROM users WHERE parent_id = $this->id)");
        $fbets = $this->Common_model->get_data_by_query("SELECT * FROM bet WHERE market_id = '$mid' AND bet_type = 'fancy' AND user_id IN (SELECT id FROM users WHERE parent_id = $this->id)");
    ...
    public function profitNLoss() {
        ...
        foreach ($runners as $rk => $r) {
            $tid = $r->id;
            $allTeams[$rk]['back'] = $this->Common_model->get_single_query("SELECT SUM(profit) AS p, SUM(loss) AS l FROM bet WHERE user_id IN (SELECT id FROM users WHERE parent_id = $this->id) AND market_id = '$mkid' AND team_id = $tid AND back_lay = 'back' AND bet_type = 'matched'");
            $allTeams[$rk]['lay'] = $this->Common_model->get_single_query("SELECT SUM(profit) AS p, SUM(loss) AS l FROM bet WHERE user_id IN (SELECT id FROM users WHERE parent_id = $this->id) AND market_id = '$mkid' AND team_id = $tid AND back_lay = 'lay' AND bet_type = 'matched'");
            $allTeams[$rk]['tid'] = $tid;
        }
        $supermasterPartnership = $this->Common_model->findfield('users','id',$this->id,'commission');
        $pid = $this->Common_model->findfield('users','id',$this->id,'parent_id');
        $adminPartnership = $this->Common_model->findfield('users','id',$pid,'commission');
        $masterPartnership = 100 - ($supermasterPartnership + $adminPartnership);
        $res = array();
        foreach ($runners as $rk => $r) {
            $tid = $r->id;
            $res[$rk]['pl'] = ($masterPartnership*$this->calculateNewResult($allTeams,$rk))/100;
            $res[$rk]['id'] = $tid;
        }
    ...
    public function calculateAllUserPLByMarketId($mkid) {
        $match = $this->Common_model->get_single_query("SELECT * FROM running_matches WHERE market_id = $mkid");
        $runners = json_decode($match->teams);
        foreach ($runners as $rk => $r) {
            $tid = $r->id;
        ...
        foreach ($runners as $rk => $r) {
            $tid = $r->id;
            $res[$rk]['pl'] = $this->calculateNewResult($allTeams,$rk);
            $res[$rk]['id'] = $tid;
        }
        return $res;
        //print_r($res);
    ...
    public function showPana() {
        ...
        $masterPartnership = 100 - ($supermasterPartnership + $adminPartnership);
        $runners = json_decode($match->teams);
        $users = $this->Common_model->get_data_by_query("SELECT * FROM users WHERE parent_id = $this->id");
        ...
        foreach ($users as $uk => $u) {
            ...
            foreach ($runners as $rk => $r) {
                $tid = $r->id;
                $allTeams[$rk]['back'] = $this->Common_model->get_single_query("SELECT SUM(profit) AS p, SUM(loss) AS l FROM bet WHERE user_id = $uid AND market_id = '$mkid' AND team_id = $tid AND back_lay = 'back' AND bet_type = 'matched'");
                $allTeams[$rk]['lay'] = $this->Common_model->get_single_query("SELECT SUM(profit) AS p, SUM(loss) AS l FROM bet WHERE user_id = $uid AND market_id = '$mkid' AND team_id = $tid AND back_lay = 'lay' AND bet_type = 'matched'");
                $allTeams[$rk]['tid'] = $tid;
            }
            foreach ($runners as $rk => $r) {
                $tid = $r->id;
                $pl = ($masterPartnership*$this->calculateNewResult($allTeams,$rk))/100;
    ...
    public function teamProfitLossUser() {
        $mid = $this->input->get('market_id');
        $match = $this->Common_model->get_single_query("select * from running_matches where market_id = '$mid'");
        $supermasterPartnership = $this->Common_model->findfield('users','id',$this->id,'commission');
        $pid = $this->Common_model->findfield('users','id',$this->id,'parent_id');
        ...
        $p_l = array();
        $bets = $this->Common_model->get_data_by_query("SELECT a.* FROM bet a LEFT JOIN users_with_groups b ON a.user_id = b.id WHERE a.user_id IN(SELECT id FROM users WHERE parent_id = $this->id) AND a.market_id = '$mid' AND a.bet_type = 'matched'");
        $users = $this->Common_model->get_data_by_query("select * from users where parent_id = $this->id");
        foreach ($users as $uk => $u) {
           $uid = $u['id'];
           $team1backprofitloss = $this->Common_model->get_single_query("SELECT SUM(profit) AS p, SUM(loss) AS l FROM bet WHERE user_id = $uid AND market_id = '$mid' AND team_id = $team1 AND back_lay = 'back' AND bet_type = 'matched'");
           $team1layprofitloss = $this->Common_model->get_single_query("SELECT SUM(profit) AS p, SUM(loss) AS l FROM bet WHERE user_id = $uid AND market_id = '$mid' AND team_id = $team1 AND back_lay = 'lay' AND bet_type = 'matched'");
           $team2backprofitloss = $this->Common_model->get_single_query("SELECT SUM(profit) AS p, SUM(loss) AS l FROM bet WHERE user_id = $uid AND market_id = '$mid' AND team_id = $team2 AND back_lay = 'back' AND bet_type = 'matched'");
           $team2layprofitloss = $this->Common_model->get_single_query("SELECT SUM(profit) AS p, SUM(loss) AS l FROM bet WHERE user_id = $uid AND market_id = '$mid' AND team_id = $team2 AND back_lay = 'lay' AND bet_type = 'matched'");
           ...
           $team1_pl = ($team1win*$masterPartnership)/100;
           $team2_pl = ($team2win*$masterPartnership)/100;
           ...
           $p_l[$uk]['username'] = $u['username'];
           $p_l[$uk]['uid']      = $u['id'];
           $p_l[$uk]['team1_pl'] = $team1_pl;
           $p_l[$uk]['team1_cl'] = $team1_cl;
           $p_l[$uk]['team2_pl'] = $team2_pl;
           $p_l[$uk]['team2_cl'] = $team2_cl;
        }
    ...
    public function getBookedFancy() {
        ...
        $mid = $this->input->get('market_id');
        $bets = $this->Common_model->get_data_by_query("SELECT a.* FROM bet a LEFT JOIN users_with_groups b ON a.user_id = b.id WHERE a.user_id IN(SELECT id FROM users WHERE parent_id = $this->id) AND a.market_id = '$mid' AND a.team = '$runner' AND a.bet_type = 'fancy'");
        ...
        foreach ($odds as $ok => $o) {
            $b = $this->Common_model->get_single_query("SELECT SUM(a.profit) AS p, SUM(a.loss) AS l FROM bet a LEFT JOIN users_with_groups b ON a.user_id = b.id WHERE a.user_id IN(SELECT id FROM users WHERE parent_id = $this->id) AND a.market_id = '$mid' AND a.team = '$runner' AND a.bet_type = 'fancy' AND a.odd = ".$o['odd']." AND back_lay = 'back'");
            $l = $this->Common_model->get_single_query("SELECT SUM(a.profit) AS p, SUM(a.loss) AS l FROM bet a LEFT JOIN users_with_groups b ON a.user_id = b.id WHERE a.user_id IN(SELECT id FROM users WHERE parent_id = $this->id) AND a.market_id = '$mid' AND a.team = '$runner' AND a.bet_type = 'fancy' AND a.odd = ".$o['odd']." AND back_lay = 'lay'");
            echo '<tr>
                    <td>'.$i++.'</td>
                    <td>'.$o['name'].'</td>
