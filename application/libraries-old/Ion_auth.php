...
class Ion_auth
{
	...
	public function is_supermaster($id=false)
	{
		$supermaster_group = 'supermaster';
		return $this->in_group($supermaster_group, $id);
	}
	public function is_master($id=false)
	{
		$master_group = 'master';
		return $this->in_group($master_group, $id);
	}
