                ...
                <table class="table table-striped table-border">
                  ...
                  <tbody>
                    <?php $pt = 0; foreach($plus as $p):?>
                      ...
                      <tr>
                        <td><?=$p['name'];?></td>
                        <td><?php if($p['username'] == 'Own' || $p['username'] == 'Cash') {
                          echo $p['username'];
                        } else {
                          echo '<a href="'.base_url('SuperAdmin/chipSummary?user_id='.$p['uid']).'">'.$p['username'].'</a>';
                        }
                        ?>
                        </td>
                        ...
                        <td>
                          <?php if($p['username'] != 'Cash') { ?>
                            <a href="<?=base_url('SuperAdmin/userBetHistory?user_id='.$p['uid']);?>" class="btn btn-primary btn-sm" style="color: white;">History</a>
                          <?php } ?>
                          <?php if($p['username'] == 'Own' || $p['chips'] == 0 || $p['username'] == 'Cash') { } else { ?>
                  ...
                  <tfoot>
                    <tr class="footers">
                      ...
                      <th><span class="text-white"><?=round($pt,2);?></span></th>
                      <th></th>
                    </tr>
                  </tfoot>
                </table>
                ...
                <table class="table table-striped table-border">
                  ...
                  <tbody>
                    <?php $lt = 0; foreach($minus as $m):?>
                      ...
                      <tr>
                        <td><?=$m['name'];?></td>
                        <td><?php if($m['username'] == 'Own' || $m['username'] == 'Cash') {
                          echo $m['username'];
                        } else {
                          echo '<a href="'.base_url('SuperAdmin/chipSummary?user_id='.$m['uid']).'">'.$m['username'].'</a>';
                        }
                        ?>
                        </td>
                        ...
                        <td>
                          <?php if($m['username'] != 'Cash') { ?>
                            <a href="<?=base_url('SuperAdmin/userBetHistory?user_id='.$m['uid']);?>" class="btn btn-primary btn-sm" style="color: white;">History</a>
                          <?php } ?>
                          <?php if($m['username'] == 'Own' || $m['chips'] == 0 || $m['username'] == 'Cash') { } else { ?>
                  ...
                  <tfoot>
                    <tr class="footers">
                      <th colspan="2">Total</th>
                      <th><span class="text-white"><?=round($lt,2);?></span></th>
                      <th></th>
                    </tr>
                  </tfoot>
                </table>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?=base_url('SuperAdmin/chipSettlement');?>">
          <div class="row">
