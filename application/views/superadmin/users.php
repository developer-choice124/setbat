                            ...
                            <tbody>
                                ...
                                foreach ($users as $user) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('SuperAdmin/masters?master_id=' . $user->parent_id); ?>"><?= $this->Common_model->findfield('users', 'id', $user->parent_id, 'username'); ?></a></td>
                                        <td><?php $smid = $this->Common_model->findfield('users', 'id', $user->parent_id, 'parent_id'); ?>
                                            <a href="<?= base_url('SuperAdmin/supermasters?supermaster_id=' . $smid); ?>"><?= $this->Common_model->findfield('users', 'id', $smid, 'username'); ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('SuperAdmin/editUser?user_id=' . $user->id) ?>"><i class="ti-pencil-alt" data-toggle="tooltip" title="Edit"></i></a>&nbsp;&nbsp;
                                            ...
                                            <a href="<?= base_url('SuperAdmin/userBetHistory?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Bet History"><span class="label label-darkblue rounded-0" style="border-radius: 0;">B</span></a>
                                            <a href="<?= base_url('SuperAdmin/userAccountStatement?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Account Statement"><span class="label label-darkblue rounded-0" style="border-radius: 0;">S</span></a>
                                            <a href="<?= base_url('SuperAdmin/userProfitLoss?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Profit & Loss"><span class="label label-darkblue rounded-0" style="border-radius: 0;">P-L</span></a>
...
<div id="passwordModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('SuperAdmin/resetUserPassword'); ?>" method="POST">
...
<div id="paymentModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('SuperAdmin/addMoney'); ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="col-md-2">
                                <center><button type="submit" class="btn btn-darkblue">Add Chips</button></center>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <hr />
            <form method="post" action="<?= base_url('SuperAdmin/witdrawChips'); ?>">
                <div class="modal-body">
...
<div id="userModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('SuperAdmin/updateUserInfo'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-darkblue">Update</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            </form>
        </div>
...
<script>
    ...
    function userInfo(id) {
        $.ajax({
            url: "<?php echo site_url('SuperAdmin/userInfo?user_id=') ?>" + id,
            type: "POST",
            //dataType: "JSON",
            success: function(data) {
                console.log(data);
    ...
    function lockBetting(id, status) {
        swal({
            ...
            $.ajax({
                url: "<?php echo site_url('SuperAdmin/lockBetting?user_id=') ?>" + id + "&status=" + status,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    location.reload();
    ...
    function showMatch(id, status) {
        swal({
            ...
            $.ajax({
                url: "<?php echo site_url('SuperAdmin/showMatch?user_id=') ?>" + id + "&status=" + status,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    location.reload();
    ...
    function setSessionCommission(commission, id) {
        if (parseFloat(commission) > 3) {
            ...
            $.ajax({
                url: "<?php echo site_url('SuperAdmin/updateSessionCommission?user_id=') ?>" + id + "&commission=" + commission,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    console.log(data)
    ...
    function setOddCommission(commission, id) {
        if (parseFloat(commission) > 2) {
            ...
            $.ajax({
                url: "<?php echo site_url('SuperAdmin/updateOddCommission?user_id=') ?>" + id + "&commission=" + commission,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    console.log(data)
