                ...
                <table class="table table-striped table-border">
                  ...
                  <tbody>
                    <?php $pt = 0; foreach($plus as $p):?>
                      ...
                      <tr>
                        ...
                        <td><a href="<?=base_url('SuperAdmin/userBetHistory?user_id='.$p['uid']);?>" class="btn btn-primary btn-sm" style="color: white;">History</a>
                          <?php if($p['username'] == 'Own' || $p['username'] == 'Parent A/C'  || $p['chips'] == 0) { } else { ?>
                  ...
                  <tfoot>
                    <tr class="footers">
                      ...
                      ?>
                      <th><span class="text-white"><?=round($totp,2);?></span></th>
                      <th></th>
                    </tr>
                  </tfoot>
                </table>
                ...
                <table class="table table-striped table-border">
                    ...
                    <?php $lt = 0; foreach($minus as $m):?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php if($m['username'] == 'Own' || $m['username'] == 'Parent A/C' || $m['chips'] == 0) { } else { ?>
                  ...
                  <tfoot>
                    <tr class="footers">
                      ...
                      ?>
                      <th><span class="text-white"><?=round($totl,2);?></span></th>
                      <th></th>
                    </tr>
                  </tfoot>
                </table>
