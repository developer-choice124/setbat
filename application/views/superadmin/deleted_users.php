                            ...
                            <tbody>
                              ...
                              <?php $gid = $this->Common_model->findfield('users_groups', 'user_id', $user->id, 'group_id'); ?>
                                <tr>
                                    ...
                                    <td><?php if($user->deleted == 'yes') {?>
                                        <a href="#" onclick="restoreUser('<?= $user->id?>')">Restore</a>
                                    <?php } ?>
                                    </td>
                                    <td>
...
<script>
    ...
    function restoreUser(id)
    {
      swal({   
            ...
            confirmButtonText: "Yes, restore please!",   
            closeOnConfirm: false 
        }, function(){   
             $.ajax({
                url : "<?php echo site_url('SuperAdmin/restoreUser')?>/"+id,
                type: "POST",
                //dataType: "JSON",
