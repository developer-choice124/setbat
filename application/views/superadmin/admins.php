                            ...
                            <tbody>
                              ...
                              <?php $gid = $this->Common_model->findfield('users_groups', 'user_id', $user->id, 'group_id'); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?=base_url('SuperAdmin/supermasters?admin_id='.$user->id);?>">View SuperMasters</a>
                                    </td>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#childModal" onclick="addChild('<?=$user->id;?>')"><i class="fa fa-user" data-toggle="tooltip" title="Add SuperMaster"></i></a>&nbsp;&nbsp;
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add SuperMaster</h4>
      </div>
