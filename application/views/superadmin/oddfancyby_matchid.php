                              ...
                              <?php $pt = 0; foreach($plus as $p):?>
                                ...
                                <tr>
                                  ...
                                  <td><?php if($p['username'] == 'Own' || $p['username'] == 'Parent A/C') {
                                    ...
                                    echo '<a href="'.base_url('SuperAdmin/oddFancyByMatchId?match_id='.$bets[0]['match_id'].'&user_id='.$p['uid'].'&type='.$type).'">'.$p['username'].'</a>';
                                  }
                                  ?>
                                  </td>
                                  <td><?=$p['chips'];?></td>
                              ...
                              <?php $lt = 0; foreach($minus as $m):?>
                                ...
                                <tr>
                                  ...
                                  <td><?php if($m['username'] == 'Own' || $m['username'] == 'Parent A/C') {
                                    ...
                                    echo '<a href="'.base_url('SuperAdmin/oddFancyByMatchId?match_id='.$bets[0]['match_id'].'&user_id='.$m['uid'].'&type='.$type).'">'.$m['username'].'</a>';
                                  }
                                  ?>
                                  </td>
                                  <td><?=$m['chips'];?></td>
