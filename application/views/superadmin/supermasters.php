...
<div class="container-fluid">
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Super Masters</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Super Masters</li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
                            ...
                            <tbody>
                              ...
                              <?php $gid = $this->Common_model->findfield('users_groups', 'user_id', $user->id, 'group_id'); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?=base_url('SuperAdmin/masters?supermaster_id='.$user->id);?>">View Masters</a>
                                    </td>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#childModal" onclick="addChild('<?=$user->id;?>')"><i class="fa fa-user" data-toggle="tooltip" title="Add Master"></i></a>&nbsp;&nbsp;
