        ...
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                  ...
                  <div class="pull-right"><a href="<?=base_url('SuperAdmin/runningCricket');?>">Back</a><a href="#" data-perform="panel-collapse"><i class="ti-minus"></i></a></div>
                </div>
                <div class="panel-body bg-matchodd">
                          ...
                          <div class="table-responsive" id="singleMatchTable">
                              <table class="table table-bordered table-condensed" width="100%" >
                                <tr>
                                  ...
                                  <th colspan="3" style="background: #008efa; color: white; border: none !important; min-width: 50px;  max-width: 50px;"><center>back</center></th>
                            ...
                            <div class="table-responsive" id="fancyTable">
                              <table class="table table-bordered" width="100%">
                                <tr>
                                  ...
                                  <th style="background: #008efa; color: white; border: none !important; min-width: 50px;  max-width: 50px;"><center>YES(B)</center></th>
                                  <th width="17%"></th>
                                </tr>
                                <?php if($dfancy) {
                                  $did = array();
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      profitLossData = setInterval("profitNLoss()",3000);
      scoreReload();
    });

    function scoreReload() {
      $.ajax({
          url: "<?php echo site_url('SuperAdmin/scoreReload?market_id=') ?>" + marketId + "&match_id=" + matchId,
          type: "POST",
          dataType: 'json',
    ...
    function profitNLoss() {
      $.ajax({
        url : "<?php echo site_url('SuperAdmin/profitNLoss?market_id=')?>"+marketId,
        type: "POST",
        dataType: 'json',
    ...
    function matchReload() {
      ...
      $.ajax({
        url : "<?php echo site_url('SuperAdmin/matchReload?market_id=')?>"+mid,
        type: "POST",
        success: function(data)
        {
    ...
    function fancyReload() {
      var mid = "<?=$match->market_id;?>";
      $.ajax({
        url : "<?php echo site_url('SuperAdmin/fancyReload?market_id=')?>"+mid,
        type: "POST",
    ...
    function betReload() {
      var mid = "<?=$match->market_id;?>";
      $.ajax({
        url : "<?php echo site_url('SuperAdmin/betReload?market_id=')?>"+mid,
        type: "POST",
        success: function(data)
        {
          $("#betReload").html(data);
    ...
    function panaReload() {
      var mid = "<?=$match->market_id;?>";
      $.ajax({
        url : "<?php echo site_url('SuperAdmin/showPana?market_id=')?>"+mid,
        type: "POST",
        success: function(data)
        {
          //console.log(data);
    ...
    function getBookedFancy(runner,mid) {
      $.ajax({
        url : "<?php echo site_url('SuperAdmin/getBookedFancy?runner=');?>"+runner+"&market_id="+mid,
        type: "POST",
        success: function(data)
        {
          console.log(data);
