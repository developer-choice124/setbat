                                ...
                                <form method="post" action="#">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input id="backOdd" 
                                                   readonly="readonly"
                                                   type="text" value="0" name="odd" class="form-control" onchange="profitLossBack(this.value, 'yes')" onkeyup="profitLossBack(this.value, 'yes')" onkeydown="profitLossBack(this.value, 'yes')">
                                        </div>
                                        <div class="col-md-6">
