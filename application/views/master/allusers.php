        ...
        <div class="col-sm-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?= base_url('Master/addUser'); ?>" method="post" class="form-horizontal">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($id == $user->id) {
                                                ...
                                                echo $user->active == 0 ? '<a href="' . base_url('Master/activateUser?id=' . $user->id . '&status=' . $user->active) . '">Block</a>' : '<a href="' . base_url('Master/activateUser?id=' . $user->id . '&status=' . $user->active) . '">Active</a>';
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <a href="<?= base_url('Master/editUser?user_id=' . $user->id) ?>"><i class="ti-pencil-alt" data-toggle="tooltip" title="Edit"></i></a>&nbsp;&nbsp;
                                            ...
                                            <a href="<?= base_url('Master/userBetHistory?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Bet History"><span class="label label-info rounded-0" style="border-radius: 0;">B</span></a>
                                            <a href="<?= base_url('Master/userAccountStatement?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Account Statement"><span class="label label-info rounded-0" style="border-radius: 0;">S</span></a>
                                            <a href="<?= base_url('Master/userProfitLoss?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Profit & Loss"><span class="label label-info rounded-0" style="border-radius: 0;">P-L</span></a>
...
<div id="passwordModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('Master/resetUserPassword'); ?>" method="POST">
...
<div id="paymentModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('Master/addMoney'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
            ...
            <hr />
            <form method="post" action="<?= base_url('Master/witdrawChips'); ?>">
                <div class="modal-body">
...
<div id="userModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('Master/updateUserInfo'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
...
<script>
    ...
    function removeUser(id) {
        swal({
            ...
            $.ajax({
                url: "<?php echo site_url('Master/deleteUser') ?>/" + id,
                type: "POST",
                //dataType: "JSON",
    ...
    function userInfo(id) {
        $.ajax({
            url: "<?php echo site_url('Master/userInfo?user_id=') ?>" + id,
            type: "POST",
            //dataType: "JSON",
            success: function(data) {
                //console.log(data);
    ...
    function lockBetting(id, status) {
        swal({
            ...
            $.ajax({
                url: "<?php echo site_url('Master/lockBetting?user_id=') ?>" + id + "&status=" + status,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    location.reload();
    ...
    function showMatch(id, status) {
        swal({
            ...
            $.ajax({
                url: "<?php echo site_url('Master/showMatch?user_id=') ?>" + id + "&status=" + status,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    location.reload();
    ...
    function setSessionCommission(commission, id) {
        if (parseFloat(commission) > 3) {
            ...
            $.ajax({
                url: "<?php echo site_url('Master/updateSessionCommission?user_id=') ?>" + id + "&commission=" + commission,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    console.log(data)
    ...
    function setOddCommission(commission, id) {
        if (parseFloat(commission) > 2) {
            ...
            $.ajax({
                url: "<?php echo site_url('Master/updateOddCommission?user_id=') ?>" + id + "&commission=" + commission,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    console.log(data)
