        ...
        <div class="col-sm-12">
            <div class="panel panel-darkblue">
                <div class="panel-heading">
                     Update Users
                    <div class="pull-right"><a class="btn btn-darkblue" href="<?=base_url('Admin/'.($user->group_name=='user'?'users': ($user->group_name == 'master'?'masters':'supermasters')));?>"><i class="fa fa-user m-l-5"></i>All Users</a><a href="#" data-perform="panel-collapse"><i class="ti-minus"></i></a></div>
                </div>
                <div class="panel-body">
                    <div id="infoMessage"><?php if($this->session->flashdata('message')) { echo $this->session->flashdata('message'); }?></div>
                    <form action="<?=base_url('Admin/updateUser/'.$user->id);?>" method="post" class="form-horizontal">
