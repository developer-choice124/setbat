              ...
              <tbody>
                ...
                foreach ($crickets as $c) : ?>
                  <tr>
                    ...
                    <td><a href="<?= base_url('Admin/matchOdds?match_id=' . $c['event_id'] . '&market_id=' . $c['market_id']); ?>" data-toggle="tooltip" title="View Match Odds">Match Odds</a></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
