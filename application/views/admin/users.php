                            ...
                            <tbody>
                                ...
                                foreach ($users as $user) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('Admin/masters?master_id=' . $user->parent_id); ?>"><?= $this->Common_model->findfield('users', 'id', $user->parent_id, 'username'); ?></a></td>
                                        <td><?php $smid = $this->Common_model->findfield('users', 'id', $user->parent_id, 'parent_id'); ?>
                                            <a href="<?= base_url('Admin/supermasters?supermaster_id=' . $smid); ?>"><?= $this->Common_model->findfield('users', 'id', $smid, 'username'); ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('Admin/userBetHistory?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Bet History"><span class="label label-darkblue rounded-0" style="border-radius: 0;">B</span></a>
                                            <a href="<?= base_url('Admin/userAccountStatement?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Account Statement"><span class="label label-darkblue rounded-0" style="border-radius: 0;">S</span></a>
                                            <a href="<?= base_url('Admin/userProfitLoss?user_id=' . $user->id) ?>" data-toggle="tooltip" title="Profit & Loss"><span class="label label-darkblue rounded-0" style="border-radius: 0;">P-L</span></a>
...
<script>
    ...
    function showMatch(id, status) {
        swal({
            ...
            $.ajax({
                url: "<?php echo site_url('Admin/showMatch?user_id=') ?>" + id + "&status=" + status,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    location.reload();
    ...
    function setSessionCommission(commission, id) {
        if (parseFloat(commission) > 3) {
            ...
            $.ajax({
                url: "<?php echo site_url('Admin/updateSessionCommission?user_id=') ?>" + id + "&commission=" + commission,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    console.log(data)
    ...
    function setOddCommission(commission, id) {
        if (parseFloat(commission) > 2) {
            ...
            $.ajax({
                url: "<?php echo site_url('Admin/updateOddCommission?user_id=') ?>" + id + "&commission=" + commission,
                type: "POST",
                //dataType: "JSON",
                success: function(data) {
                    console.log(data)
