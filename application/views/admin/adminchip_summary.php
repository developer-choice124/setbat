                    ...
                    <?php $pt = 0; foreach($plus as $p):?>
                      ...
                      <tr>
                        ...
                        <td><?php if($p['username'] == 'Own' || $p['username'] == 'Cash') {
                          ...
                          echo '<a href="'.base_url('Admin/chipSummary?user_id='.$p['uid']).'">'.$p['username'].'</a>';
                        }
                        ?>
                        </td>
                        ...
                        <td>
                          <?php if($p['username'] != 'Cash') { ?>
                            <a href="<?=base_url('Admin/userBetHistory?user_id='.$p['uid']);?>" class="btn btn-primary btn-sm" style="color: white;">History</a>
                          <?php } ?>
                    ...
                    <?php $lt = 0; foreach($minus as $m):?>
                      ...
                      <tr>
                        ...
                        <td><?php if($m['username'] == 'Own' || $m['username'] == 'Cash') {
                          ...
                          echo '<a href="'.base_url('Admin/chipSummary?user_id='.$m['uid']).'">'.$m['username'].'</a>';
                        }
                        ?>
                        </td>
                        ...
                        <td>
                          <?php if($m['username'] != 'Cash') { ?>
                            <a href="<?=base_url('Admin/userBetHistory?user_id='.$m['uid']);?>" class="btn btn-primary btn-sm" style="color: white;">History</a>
                          <?php } ?>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?=base_url('Admin/chipSettlement');?>">
          <div class="row">
