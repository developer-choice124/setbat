                        ...
                        <table id="allusers" class="table table-condensed" >
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><a href="<?=base_url('Admin/oddFancyByMatchId?match_id='.$statements[0]['match_id'].'&user_id='.$statements[0]['user_id'].'&type=matched');?>">Show Bets</a></td>
                            </tr>
                            <tr>
                              <td>2</td>
                              <td><?=date('d-M-Y H:i:sa',strtotime($statements[0]['transaction_date']));?></td>
                              ...
                              <td><a href="<?=base_url('Admin/oddFancyByMatchId?match_id='.$statements[0]['match_id'].'&user_id='.$statements[0]['user_id'].'&type=fancy');?>">Show Fancy</a></td>
                            </tr>
                          </tbody>
                        </table>
                    </div>
