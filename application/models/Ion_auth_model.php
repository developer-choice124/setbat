...
class Ion_auth_model extends CI_Model
{
	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		if ($query->num_rows() === 1)
		{
			...
			if ($password === TRUE)
			{
				...
				// Max one login allow
				$this->db->delete('ci_sessions', array('id' => $this->ion_auth->user()->row()->currentsessionid)); 
				$sdata = array(
	...
	**/
	...
	public function add_political(array $data){
		$this->db->insert('political_profile', $data);
		return true;
	}
}
