        ...
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                     Update Users
                    <div class="pull-right"><a class="btn btn-info" href="<?=base_url('SuperMaster/'.($user->group_name=='user'?'users':'masters'));?>"><i class="fa fa-user m-l-5"></i>All Users</a><a href="#" data-perform="panel-collapse"><i class="ti-minus"></i></a></div>
                </div>
                <div class="panel-body">
                    <div id="infoMessage"><?php if($this->session->flashdata('message')) { echo $this->session->flashdata('message'); }?></div>
                    <form action="<?=base_url('SuperMaster/updateUser/'.$user->id);?>" method="post" class="form-horizontal">
