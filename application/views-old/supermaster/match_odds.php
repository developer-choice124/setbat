...
<script type="text/javascript">
    ...
    function profitNLoss() {
      $.ajax({
        url : "<?php echo site_url('SuperMaster/profitNLoss?market_id=')?>"+marketId+"&team1="+team1Id+"&team2="+team2Id,
        type: "POST",
        dataType: 'json',
    ...
    function panaReload() {
      var mid = "<?=$match->market_id;?>";
      $.ajax({
        url : "<?php echo site_url('SuperMaster/teamProfitLossMaster?market_id=')?>"+mid,
        type: "POST",
        success: function(data)
        {
          $("#panaTable").html(data);
