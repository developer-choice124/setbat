...
<meta name="title" content="Admin Login | The Schule">
    ...
    <div class="white-box">
      <form class="form-horizontal form-material" id="loginform" action="<?php base_url('auth/login')?>" method="POST">
        ...
        <div class="form-group ">
          <div class="col-xs-12">
            <input class="form-control" type="text" required="required" placeholder="<?php echo lang('email');?>" name="identity">
          </div>
        </div>
        <div class="form-group">
          <div class="col-xs-12">
        ...
        <div class="form-group text-center m-t-20">
          <div class="col-xs-12">
            <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit"><?php echo lang('login_heading');?></button>
          </div>
        </div>
        <!--div class="row">
