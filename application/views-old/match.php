    ...
    <div class="col-md-12"> 
      ...
      <div class="card">
        <ul class="nav nav-tabs">
          <li class="nav-item">
            <a class="nav-link active" href="<?=base_url('MsAppUser/match?market_id='.$match->market_id.'&match_id='.$match->event_id);?>">Match Odds</a>
          </li>
          <li class="nav-item">
        ...
        <div class="card-body" style="padding: 0 !important;">
          ...
          <div class="row">
            ...
            <div class="col-3 text-white text-center font-weight-bold border" style="background: #29B6F6;">
              <center>Lagai</center>
            </div>
      ...
      <div class="card border">
        ...
        <div class="card-body pt-1 d-none" id="backBetDiv" style="background: #b6e8ff;">
          ...
          <div class="row pb-2">
            ...
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossBack(<?=round($cuser->chip_value_1);?>)"><?=round($cuser->chip_value_1);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossBack(<?=round($cuser->chip_value_2);?>)"><?=round($cuser->chip_value_2);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossBack(<?=round($cuser->chip_value_3);?>)"><?=round($cuser->chip_value_3);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossBack(<?=round($cuser->chip_value_4);?>)"><?=round($cuser->chip_value_4);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossBack(<?=round($cuser->chip_value_5);?>)"><?=round($cuser->chip_value_5);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossBack(<?=round($cuser->chip_value_6);?>)"><?=round($cuser->chip_value_6);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossBack(0)">Clear</button>
        ...
        <div class="card-body pt-1 d-none" id="layBetDiv" style="background: #ffbacc;">
          ...
          <div class="row pb-2">
            ...
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossLay(<?=round($cuser->chip_value_1);?>)"><?=round($cuser->chip_value_1);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossLay(<?=round($cuser->chip_value_2);?>)"><?=round($cuser->chip_value_2);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossLay(<?=round($cuser->chip_value_3);?>)"><?=round($cuser->chip_value_3);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossLay(<?=round($cuser->chip_value_4);?>)"><?=round($cuser->chip_value_4);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossLay(<?=round($cuser->chip_value_5);?>)"><?=round($cuser->chip_value_5);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossLay(<?=round($cuser->chip_value_6);?>)"><?=round($cuser->chip_value_6);?></button>
            <button type="button" class="btn btn-info btn-sm" onclick="calculateProfitLossLay(0)">Clear</button>
          <div class="clearfix pb-2"></div>
              ...
              foreach ($fancies as $fkey => $f) {
                if (in_array($f['SelectionId'], $did)) { ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-3 text-center border" style="background: #ffffea;" onclick="showLayBetDiv('<?= $f['SelectionId'] ?>','<?= $f['RunnerName']; ?>','<?=$fkey;?>','back','matched','<?=$lprice;?>','<?=$lsize;?>')">
                      <b><?= $f['LayPrice1']; ?></b><br/><?= $f['LaySize1']; ?></div>
                    <div class="col-3 text-center border" style="background: #ffffea;" 
                      onclick="getBackLay('lay', '<?= $f['LaySize1']; ?>', '<?= $f['RunnerName']; ?>', '<?= $f['SelectionId'] ?>', '<?= $fkey; ?>', 'fancy', '<?= $f['LayPrice1']; ?>')"
