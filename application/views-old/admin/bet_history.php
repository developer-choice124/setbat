                            ...
                            <tbody>
                                <?php $i = 1; foreach($bets as $b):?>
                                  <tr class="<?=$b['back_lay'] == 'back' ? 'back' : 'lay' ;?>">
                                    ...
                                    <td><?=$b['username'];?></td>
                                    <td>
                                      <?php if($b['bet_type'] == 'fancy' && $b['status'] == 'pending') { ?>
                                        <a href="<?=base_url('Admin/singleFancy?market_id='.$b['market_id'].'&fancy_name='.$b['team']);?>"><?=$b['match_name'];?></a>
                                      <?php } else {
                                        echo $b['match_name'];
                                      } ?>
                                    </td>
                                    ...
                                    <td><?=$b['ip'];?></td>
                                    <td><?=$b['id'];?></td>
                                    <td><?=anchor("Admin/deleteBetById?id=".$b['id'],"Delete",array('onclick' => "return confirm('Do you want delete this bet')"));?></td>
                                  </tr>
                                <?php endforeach;?>
                            </tbody>
                        </table>
