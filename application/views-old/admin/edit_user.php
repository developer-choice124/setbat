        ...
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                     Update Users
                    <div class="pull-right"><a class="btn btn-info" href="<?=base_url('Admin/'.($user->group_name=='user'?'users': ($user->group_name == 'master'?'masters':'supermasters')));?>"><i class="fa fa-user m-l-5"></i>All Users</a><a href="#" data-perform="panel-collapse"><i class="ti-minus"></i></a></div>
                </div>
