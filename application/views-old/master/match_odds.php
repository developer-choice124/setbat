                            ...
                            <div class="table-responsive" id="fancyTable">
                              <table class="table table-bordered" width="100%">
                                ...
                                <?php foreach ($fancies as $fkey => $f) { ?>
                                  ...
                                  <tr>
                                    <td><?=$f['RunnerName'];?><span class="pull-right"><button class="btn btn-warning btn-sm" onclick="getBookedFancy('<?=$f['SelectionId'];?>','<?=$match->market_id;?>')" data-toggle="modal" data-target="#bookFancyModal">book</button></span></td>
...
<script type="text/javascript">
    ...
    function profitNLoss() {
      $.ajax({
        url : "<?php echo site_url('Master/profitNLoss?market_id=')?>"+marketId,
        type: "POST",
        dataType: 'json',
    ...
    function matchReload() {
      ...
      $.ajax({
        url : "<?php echo site_url('Master/matchReload?market_id=')?>"+mid,
        type: "POST",
        success: function(data)
        {
    ...
    function fancyReload() {
      var mid = "<?=$match->market_id;?>";
      $.ajax({
        url : "<?php echo site_url('Master/fancyReload?market_id=')?>"+mid,
        type: "POST",
    ...
    function betReload() {
      var mid = "<?=$match->market_id;?>";
      $.ajax({
        url : "<?php echo site_url('Master/betReload?market_id=')?>"+mid,
        type: "POST",
        success: function(data)
        {
          $("#betReload").html(data);
    ...
    function panaReload() {
      var mid = "<?=$match->market_id;?>";
      $.ajax({
        url : "<?php echo site_url('Master/teamProfitLossUser?market_id=')?>"+mid,
        type: "POST",
        success: function(data)
        {
          $("#panaTable").html(data);
    ...
    function getBookedFancy(fid,mid) {
      $.ajax({
        url : "<?php echo site_url('Master/getBookedFancy?fancy_id=');?>"+fid+"&market_id="+mid,
        type: "POST",
        success: function(data)
        {
