                ...
                <table class="table table-striped table-border">
                    ...
                    <?php $pt = 0; foreach($plus as $p):?>
                      ...
                      <tr>
                        ...
                        <td><?php if($p['username'] == 'Own' || $p['username'] == 'Parent A/C') {
                          ...
                          echo '<a href="'.base_url('Master/chipSummary?user_id='.$p['uid']).'">'.$p['username'].'</a>';
                        }
                        ?>
                        </td>
                        <td><?=round($p['chips'],2);?></td>
                        <td><a href="<?=base_url('Master/userBetHistory?user_id='.$p['uid']);?>" class="btn btn-primary btn-sm" style="color: white;">History</a>
                  ...
                  <tfoot>
                    <tr class="footers">
                      ...
                      ?>
                      <th><span class="text-success"><?=round($totp,2);?></span></th>
                      <th></th>
                    </tr>
                  </tfoot>
                </table>
                ...
                <table class="table table-striped table-border">
                    ...
                    <?php $lt = 0; foreach($minus as $m):?>
                      ...
                      <tr>
                        ...
                        <td><?php if($m['username'] == 'Own' || $m['username'] == 'Parent A/C') {
                          ...
                          echo '<a href="'.base_url('Master/chipSummary?user_id='.$m['uid']).'">'.$m['username'].'</a>';
                        }
                        ?>
                        </td>
                        <td><?=round($m['chips'],2);?></td>
                        <td>
                          <a href="<?=base_url('Master/userBetHistory?user_id='.$m['uid']);?>" class="btn btn-primary btn-sm" style="color: white;">History</a>
                  ...
                  <tfoot>
                    <tr class="footers">
                      ...
                      ?>
                      <th><span class="text-danger"><?=round($totl,2);?></span></th>
                      <th></th>
                    </tr>
                  </tfoot>
                </table>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?=base_url('Master/chipSettlement');?>">
          <div class="row">
